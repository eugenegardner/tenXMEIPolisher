...
public abstract class SamReaderFactory {
    ...
    private static ValidationStringency defaultValidationStringency = ValidationStringency.SILENT;
    ...
    public static SamReaderFactory make() {
        return new SamReaderFactoryImpl(EnumSet.noneOf(Option.class), ValidationStringency.SILENT, DefaultSAMRecordFactory.getInstance());
    }
